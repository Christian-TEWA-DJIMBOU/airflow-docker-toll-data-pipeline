...
#Important informations necessary in python's methods
...
def download_dataset():
    ...
    if response.status_code == 200:
        ...
        print("Echec du telechargement du fichier")
...
#create a single csv file named extracted_data.csv by combining the data collected 
